    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b">
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          ...
          <Button variant="hero" size="sm" className="animate-button-pulse hover:animate-none" onClick={() => navigate("/verificar")}>
            Cadastrar meu Pet
          </Button>
        </div>
      </header>
        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center relative">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4">
              <Button variant="hero" size="xl" className="animate-button-pulse hover:animate-none" onClick={() => navigate("/verificar")}>
        ...
        <div className="container mx-auto text-center">
          <div className="relative overflow-hidden rounded-[2rem] p-12 md:p-20" style={{ background: "linear-gradient(135deg, hsl(168 55% 38%), hsl(200 70% 45%))" }}>
            ...
            <div className="relative">
              ...
              <Button variant="default" size="xl" className="animate-button-pulse hover:animate-none" onClick={() => navigate("/verificar")}>
